...
// ****************************************************************************************
  ...
  TString RootOfDataFile, RootOfMCFile, RootOfMCFileTH, JetCut, Lumi, textTitle = "";
  TString JetCuts[10];
...
//
    ...
    JetCuts[0] = "400"; minCorrupted_i[7] = (400-50)/10+1; maxCorrupted_i[7] = ((400+80)-50)/10;
...
if ( Period == "Run2015D" )
{
    ...
    DirOfDataFile = "../Output/Data/JetHT/Run2015D-16Dec2015-v1/" ;
    DirOfMCFile = "../Output/MC/QCD/" ;
    DirOfMCFileTH = "../Output/MC/QCD/" ;

    SavDir = "Dir_"+TypeOfJets+"mistagSF_Run2015D/";

    RootOfMCFile   = "JetTree_mc_FatJets_Subjets_sampleList_all_NW_";
    RootOfMCFileTH = "JetTree_mc_FatJets_Subjets_Data2015D_16Dec2015_v1_NW_";
...
// SF_Trig_Syst are taken from SF_SystTrigger_Run2015D/Trig*txt
 ...
 {
   SF_Trig_syst = 0.015; 
   SF_Run_syst = 0.0; // From SF_RunSyst/CSVv2L.txt
 }
 if( CutandStrength == "CSVv2M" )
 {
   SF_Trig_syst = 0.032; 
   SF_Run_syst = 0.01409; // From SF_RunSyst/CSVv2M.txt
 }
 if( CutandStrength == "CSVv2T" )
 {
   SF_Trig_syst = 0.12; 
   SF_Run_syst = 0.00068; // From SF_RunSyst/CSVv2T.txt
 }
...
// MC with average pile-up and without trigger
 ...
 for( unsigned long iPthat = 0; iPthat < PthatRanges.size(); ++iPthat )
 {
   ...
   //f2 = new TFile(DirOfMCFile+PthatRanges.at(iPthat)+RootOfMCFile +"0_"+CutName+".root");
   if( f2 == NULL )
   {
...
//NOTE set range first plot
     if( nPlot > 1 )
     {
       ...
       if( CutStrength == "L" ){ 
         cDMistag->SetMinimum(0.); cDMistag->SetMaximum(0.35); 
         if (CutName == "CvsL" || CutName == "CvsB") {
           cDMistag->SetMinimum(0.8); cDMistag->SetMaximum(1.4); 
         }
       }
       if( CutStrength == "M" ){ 
         cDMistag->SetMinimum(0.); cDMistag->SetMaximum(0.06); 
         if (CutName == "CvsL" || CutName == "CvsB") {
...
//NOTE: change range here third plots
       cSF->GetYaxis()->SetRangeUser(0.4,1.6);
...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  if ( PrintDBfunction )
  {
     ...
     const std::string taggr = CutName.Data();
...
void LoopPlot(TH1F &retSF, TH1F &retMistag, TString tagger = "CSVv2", TString TypeOfJets = "2DSubjets", Double_t xSigma = 4.)
{
  ...
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 1,24, tagger, "L", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 1, 3, tagger, "L", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 4, 6, tagger, "L", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 7, 9, tagger, "L", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot,10,12, tagger, "L", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot,13,15, tagger, "L", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot,16,18, tagger, "L", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot,19,24, tagger, "L", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
//
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 1, 24, tagger, "M", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 1, 8, tagger, "M", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 9, 16, tagger, "M", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 17, 24, tagger, "M", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);

  plot(retSF, retMistag, 3, !PrintWarnings, Improveplot, 1, 24, tagger, "T", false, 20., 1000., 20., 1000., "Run2015D", xSigma, false, 0.0, TypeOfJets);
}
