...
public :
   ...
   Float_t         CTag_Jet_CvsB[D_nJet];   //[nJet]
   Float_t         CTag_Jet_CvsBN[D_nJet];   //[nJet]
   Float_t         CTag_Jet_CvsBP[D_nJet];   //[nJet]
   Float_t         CTag_Jet_CvsL[D_nJet];   //[nJet]
   Float_t         CTag_Jet_CvsLN[D_nJet];   //[nJet]
   Float_t         CTag_Jet_CvsLP[D_nJet];   //[nJet]
   Int_t           nPFElectron;
   ...
   virtual void   Loop(TString TagName,
               Float_t  aPtMin = 20.,
               Float_t  aPtMax = 1000.,
               Float_t  aFreeCut = 0.,
               Int_t    aIntCut = 0,
